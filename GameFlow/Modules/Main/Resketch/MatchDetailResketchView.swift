                                ...
                                if viewStore.match.opponents.count >= 1 {
                                            ...
                                            if firstLiquiTeam!.hasTeamImage {
                                                ...
                                                if viewStore.match.opponents.first!.opponent.image_url != nil {
                                                    ...
                                                    VStack {
                                                        Circle()
                                                            .frame(width: 80, height: 80)
                                                            .foregroundStyle(Color("Gray2", bundle: .main))                                                            .overlay(alignment: .center) {
                                                                Text("?")
                                                                    .foregroundStyle(.white)
                                    ...
                                    if viewStore.match.opponents.indices.contains(1) {
                                        ...
                                        VStack(alignment: .center, spacing: 20) {
                                            ...
                                            Text(secondLiquiTeam == nil ? viewStore.match.opponents[1].opponent.name : secondLiquiTeam!.name.teamFormatted())
                                                .textCase(.uppercase)
                                                .foregroundStyle(.white)
                                                .font(.gilroy(.bold, size: 14))
                                                .frame(width: 130, height: 20)
