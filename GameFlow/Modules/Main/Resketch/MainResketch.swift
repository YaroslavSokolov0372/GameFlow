                        ...
                        VStack {
                            ...
                            TabView(selection: viewStore.$currentTab) {
                                ...
                                ForEach(SeriesType.allCases, id: \.rawValue) { type in
                                    ...
                                    case .ongoing:
                                        SeriesListViewResketch(store: Store(initialState: SeriesListResketchDomain.State(series: viewStore.isFetching ? viewStore.series : viewStore.series.ongoing, isFetching: viewStore.isFetching), reducer: {
                                    ...
                                    case .latest:
                                        SeriesListViewResketch(store: Store(initialState: SeriesListResketchDomain.State(series: viewStore.isFetching ? viewStore.series : viewStore.series.latest, isFetching: viewStore.isFetching), reducer: {
                                            SeriesListResketchDomain()
                                        }))
                                        .tag(type)
                                        .offsetX(type == viewStore.currentTab) { size in
